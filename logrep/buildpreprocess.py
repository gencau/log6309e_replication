...
#(x_train_bgl, x_test_bgl), (y_train_bgl, y_test_bgl) = load_BGL(bgl_data_dir+bgl_log_name)
#np.savez("bglPP.npz",x_train=x_train_bgl,y_train=y_train_bgl,x_test=x_test_bgl,y_test=y_test_bgl)
